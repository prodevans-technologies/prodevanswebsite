...
<div class="section def_section">
 ...
 ?>
    <div id="posts"  class="left_posts  <?php if ( $sb_style == 'business_sb'){echo " business_posts";} ?>">
      <?php  }else{ ?>
...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <?php if ($rd_data["rd_blog_sidebar"] !== 'no'){ ?>
    <div id="sidebar" class="right_sb  <?php  if ( $sb_style == 'business_sb'){echo " business_sidebar";} ?>" >
