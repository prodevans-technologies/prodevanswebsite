...
<div id="breadcrumbs">
      ...
      </a><i class="fa-angle-right crumbs_delimiter"></i><a href="<?php if($rd_data['rd_bc_shoplink']){echo esc_url($rd_data['rd_bc_shoplink']);} ?>">
      <?php if($rd_data['rd_bc_shoptext']){echo !empty( $rd_data['rd_bc_shoptext'] ) ? $rd_data['rd_bc_shoptext'] : '';} ?>
