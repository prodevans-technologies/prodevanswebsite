...
<form class="shipping_calculator woocommerce-shipping-calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">

	<h2><?php _e( 'Calculate Shipping', 'thefoxwp' ); ?></h2>

	<section class="shipping-calculator-form">

		<p class="form-row form-row-wide select_arrow" id="calc_shipping_country_field">
		...
		<p class="form-row form-row-wide state_select_arrow" id="calc_shipping_state_field">
			<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide last_row" id="calc_shipping_postcode_field">
		...
		<p class="form-row form-row-wide update_shipping_btn "><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
