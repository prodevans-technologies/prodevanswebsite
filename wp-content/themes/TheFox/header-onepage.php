...
<div id="top_bar" class="<?php echo esc_attr($topbar_type); ?>">
 ...
 ?>
    ...
    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My Account','thefoxwp'); ?>" class="topbar_signed_in">
    <?php _e('My Account','thefoxwp'); ?>
    </a>
    <?php } 
 else { ?>
    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','thefoxwp'); ?>" class="topbar_sign_in">
    <?php _e('Sign in','thefoxwp'); ?>
    </a>
    <?php if($rd_data['rd_topbar_login_type'] == 'type1'){ echo ' or '; }?>
    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','thefoxwp'); ?>" class="topbar_register">
    <?php _e('Join now','thefoxwp'); ?>
    </a>
    <?php } echo '</div>'; }  ?>
  </div>
</div>
...
<!-- header -->
<header  class="<?php if ($nav_type !== 'nav_type_15' && $nav_type !== 'nav_type_16' && $nav_type !== 'nav_type_17' && $nav_type !== 'nav_type_18' && $nav_type !== 'nav_type_19' && $nav_type !== 'nav_type_19_f' ){echo 'header_shadow '.$nav_type.''; if($rd_data['rd_header_sticky'] !== 'no'){ echo ' sticky_header '; } }elseif($nav_type == 'nav_type_19'){ echo 'fixed_header_left';}elseif($nav_type == 'nav_type_19_f'){ echo 'fixed_header_left absolute_navigation';}else{ echo esc_attr($nav_type);} if($rd_data['rd_header_shrink'] !== 'no'){ echo ' header_to_shrink'; }?> clearfix" >
<div class="wrapper">
<!-- logo -->
<?php 
...
<div id="header_socials" class="header_si" >
  ...
  <div class="header_bottom_nav header_shadow <?php if($rd_data['rd_header_sticky'] !== 'no'){ echo ' sticky_header '; } echo esc_attr($nav_type); ?> clearfix" >
