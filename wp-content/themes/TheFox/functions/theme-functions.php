...
//set variables
	...
	$output .= '.nav_type_1 ul li a,.nav_type_2 ul li a,.nav_type_3 ul li a,.nav_type_4 ul li a,.nav_type_5 ul li a,.nav_type_6 ul li a,.nav_type_7 ul li a,.nav_type_8 ul li a,.nav_type_9 ul li a,.nav_type_9_c ul li a,.nav_type_10 ul li a,.nav_type_11 ul li a,.nav_type_12 ul li a,.nav_type_13 ul li a,.nav_type_14 ul li a,.nav_type_15 ul li a,.nav_type_16 ul li a,.nav_type_17 ul li a,.nav_type_18 ul li a,.nav_type_19 ul li a,.nav_type_19_f ul li a{font-family:'.$nav_font_family.' !important; font-size:'.$nav_font_size.' !important; font-weight:'.$nav_font_weight.' !important; }';
...
// Nav_type_2 setting
	...
	$output .='.nav_type_2 nav ul li a:hover,.nav_type_2 > ul > .current-menu-item > a,.transparent_header.nav_type_2 nav > ul > .current-menu-item > a,.transparent_header.nav_type_2 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:3px solid '.$nav_current_text.'; }';
...
// Nav_type_5 setting
	...
	$output .='.nav_type_5 nav ul li a:hover,.nav_type_5 > ul > .current-menu-item > a,.transparent_header.nav_type_5 nav > ul > .current-menu-item > a,.transparent_header.nav_type_5 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important; }';	
...
// Nav_type_6 setting
	...
	$output .='.nav_type_6 nav ul li a:hover,.nav_type_6 > ul > .current-menu-item > a,.transparent_header.nav_type_6 nav > ul > .current-menu-item > a,.transparent_header.nav_type_6 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important;}';		
...
// Nav_type_9 setting
	...
	$output .='.nav_type_9 nav ul li a:hover,.nav_type_9 > ul > .current-menu-item > a,.transparent_header.nav_type_9 nav > ul > .current-menu-item > a,.transparent_header.nav_type_9 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important;}';	
...
// Nav_type_9 ( center ) setting
	...
	$output .='.nav_type_9_c nav ul li a:hover,.nav_type_9_c > ul > .current-menu-item > a,.transparent_header.nav_type_9_c nav > ul > .current-menu-item > a,.transparent_header.nav_type_9_c nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important;}';	
...
// Nav_type_10 setting
	...
	$output .='.nav_type_10 nav ul li a:hover,.nav_type_10 > ul > .current-menu-item > a,.transparent_header.nav_type_15 nav > ul > .current-menu-item > a,.transparent_header.nav_type_15 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important;}';
...
// Nav_type_11 setting
	...
	$output .='.nav_type_11 nav ul li a:hover,.nav_type_11 > ul > .current-menu-item > a,.transparent_header.nav_type_11 nav > ul > .current-menu-item > a,.transparent_header.nav_type_11 nav > ul > li > a:hover{color:'.$nav_current_text.'; border:1px solid '.$nav_current_text.' !important; background:'.$nav_current_bg.';}';	
...
// Nav_type_12 setting
	...
	$output .='.nav_type_12 nav ul li a:hover,.nav_type_12 > ul > .current-menu-item > a,.transparent_header.nav_type_12 nav > ul > .current-menu-item > a,.transparent_header.nav_type_12 nav > ul > li > a:hover{color:'.$nav_current_text.'; border:2px solid '.$nav_current_text.' !important; background:'.$nav_current_bg.';}';									
...
// Nav_type_17 setting
	...
	$output .='.nav_type_17 nav ul li a:hover,.nav_type_17 > ul > .current-menu-item > a,.transparent_header.nav_type_17 nav > ul > .current-menu-item > a,.transparent_header.nav_type_17 nav > ul > li > a:hover{color:'.$nav_current_text.'; border-top:3px solid '.$nav_current_text.' !important;}';										
...
// Nav_type_19 / 20 setting
	...
	$output .='.transparent_header.opaque_header nav > ul > li > a:hover,.transparent_header nav > ul > .current-menu-item > a,.transparent_header nav > ul > li > a:hover{color:'.$nav_current_text.' !important;}';
...
/*-----------------------------------------------------------------------------------*/
	...
	$output .= 'h1,h2,h3,h4,h5,h6{color:'.$mc_heading_color.'}.partners_left, .partners_right{background:'.$mc_heading_color.'}';
	$output .= '.def_section,blockquote{background:'.$mc_bg_color.'}';
	$output .= '#to_top:hover,.b-read-now:hover{background:'.$mc_alt_hl_color.'}';
...
/*-----------------------------------------------------------------------------------*/
	...
	$output .= '.post_quote_text,.post_quote_author,.post_single_business .post_quote_text:after{background:'.$mc_alt_hl_color.'; color:#ffffff!important;}' ;
	...
	$output .= '.comment_ctn{border:1px solid '.$mc_alt_border_color.'; background:'.$mc_alt_bg_color.'; color:'.$mc_alt_text_color.'; box-shadow:0 0px 0px '.$mc_bg_color.', 0 4px 0 -1px '.$mc_bg_color.', 0 0px 0px 0px '.$mc_bg_color.',0 0px 0px '.$mc_bg_color.', 0 4px 0 0px '.$mc_border_color.', 0px 0px 0px 0px '.$mc_bg_color.';}#business_comments #comments ul li .details span.Reply a{border:1px solid '.$mc_alt_border_color.'; background:'.$mc_alt_bg_color.'; color:'.$mc_alt_text_color.';}';	
	$output .= '.comment_count h3 a{color:'.$mc_heading_color.'}';
	$output .= '#comments ul li .details span.author a,#comments ul li .details span.author{color:'.$mc_alt_heading_color.'}';
	...
	$output .= '#business_comments #comments ul li .comment_ctn{border-bottom:1px solid '.$mc_border_color.';}';
	...
	$output .= '#business_comments #add-comment input#submit,#respond input#submit{background:'.$mc_hl_color.'; color:'.$mc_bg_color.'}#business_comments #add-comment input#submit:hover,,#respond input#submit:hover{background:'.$mc_hover_color.'; color:'.$mc_bg_color.'}#business_comments #comments ul li .details span.Reply a:hover{background:'.$mc_hl_color.' !important; color:'.$mc_bg_color.'; border-color:'.$mc_hl_color.';}';
...
$sb_bg = $rd_data['rd_sidebar_bg_color'];
$sb_alt_bg = $rd_data['rd_sidebar_alt_bg_color'];
$sb_heading = $rd_data['rd_sidebar_heading_color'];
$sb_text = $rd_data['rd_sidebar_text_color'];
$sb_hover = $rd_data['rd_sidebar_hover_color'];
$sb_border = $rd_data['rd_sidebar_border_color'];
$sb_hborder = $rd_data['rd_sidebarbar_hl_color'];
$sb_alt_hborder = $rd_data['rd_sidebarbar_althl_color'];

if ($sb_style !== 'business_sb' ){
	...
	$output .= '#sidebar:before {background:'.$sb_bg.';}.sb_widget h3{color:'.$sb_heading.'}.sb_widget > h3:before,#business_comments #add-comment h4:before,#business_comments .comment_count h3:before{ background: '.$sb_hborder.'; background: -moz-linear-gradient(90deg, '.$sb_hborder.' 0%, '.$sb_alt_hborder.' 100%); background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,'.$sb_hborder.'), color-stop(100%,'.$sb_alt_hborder.')); background: -webkit-linear-gradient(90deg, '.$sb_hborder.' 0%,'.$sb_alt_hborder.' 100%); background: -o-linear-gradient(90deg, '.$sb_hborder.' 0%,'.$sb_alt_hborder.' 100%); background: -ms-linear-gradient(90deg, '.$sb_hborder.' 0%,'.$sb_alt_hborder.' 100%); background: linear-gradient(90deg, '.$sb_hborder.' 0%,'.$sb_alt_hborder.' 100%);}';
	$output .= '#sidebar #lang_sel a,.wpb_widgetised_column #lang_sel a{color:'.$sb_text.'; background:'.$sb_alt_bg.'; border:1px solid '.$sb_border.'}#sidebar #lang_sel a:hover,.wpb_widgetised_column #lang_sel a:hover{color:'.$sb_heading.';}';
	$output .= '#sidebar .widget_recent_entries ul li,.wpb_widgetised_column .widget_recent_entries ul li{border-bottom:1px solid '.$sb_border.'}#sidebar .widget_recent_entries ul li a,.wpb_widgetised_column .widget_recent_entries ul li a{color:'.$sb_text.'}#sidebar .widget_recent_entries ul li a:hover,.wpb_widgetised_column .widget_recent_entries ul li a:hover{color:'.$sb_hover.'}';
	$output .= '#sidebar #recentcomments li,.wpb_widgetised_column #recentcomments li{border-bottom:1px solid '.$sb_border.'}#sidebar #recentcomments li a,.wpb_widgetised_column #recentcomments li a,#sidebar .tweets li a,.wpb_widgetised_column .tweets li a{color:'.$sb_heading.';}#sidebar #recentcomments li a:hover,.wpb_widgetised_column  #recentcomments li a:hover{color:'.$mc_hover_color.';}';
	$output .= '.wpb_widgetised_column .rd_widget_recent_entries li,#sidebar  .tweets li,.wpb_widgetised_column .tweets li{border-bottom:1px solid '.$sb_border.'}';
	$output .= '#sidebar .tagcloud a ,.wpb_widgetised_column .tagcloud a {background:'.$sb_alt_bg.'; border:1px solid '.$sb_border.'; color:'.$sb_text.'}#sidebar .tagcloud a:hover,.wpb_widgetised_column .tagcloud a:hover{background:'.$mc_alt_hl_color.'; border-color:'.$mc_alt_hl_color.'; color:#ffffff;}';
	$output .= '#sidebar .w_comment a,.wpb_widgetised_column .w_comment a{color:'.$sb_text.';}#sidebar .w_comment a:hover,.wpb_widgetised_column .w_comment a:hover{color:'.$sb_hover.';}';
	$output .= '#sidebar .widget_recent_entry h4 a,.wpb_widgetised_column .widget_recent_entry h4 a{color:'.$sb_heading.';}#sidebar .widget_recent_entry h4 a:hover,.wpb_widgetised_column .widget_recent_entry h4 a:hover{color:'.$sb_hover.';}';
	$output .= '#sidebar .widget_archive ul li,#sidebar .widget_meta ul li,.wpb_widgetised_column .widget_archive ul li,.wpb_widgetised_column .widget_meta ul li{border-bottom:1px solid '.$sb_border.'}#sidebar .widget_archive ul li a,#sidebar .widget_meta ul li a,.wpb_widgetised_column  .widget_archive ul li a,.wpb_widgetised_column .widget_meta ul li a{color:'.$sb_text.';}#sidebar .widget_archive ul li a:hover,#sidebar .widget_meta ul li a:hover,.wpb_widgetised_column .widget_archive ul li a:hover,.wpb_widgetised_column .widget_meta ul li a:hover{color:'.$sb_hover.';}';
	$output .= '#sidebar .page_item a, #sidebar .menu-item a,.wpb_widgetised_column .page_item a,.wpb_widgetised_column .menu-item a{border-bottom:1px solid '.$sb_border.'; color:'.$sb_text.';}#sidebar .page_item a:hover, #sidebar .menu-item a:hover,#sidebar .current_page_item a,#sidebar .current_page_item a,.wpb_widgetised_column .page_item a:hover,.wpb_widgetised_column .menu-item a:hover,.wpb_widgetised_column .current_page_item a{color:'.$sb_hover.'; }#sidebar .page_item a:before, #sidebar .menu-item a:before,.wpb_widgetised_column .page_item a:before,.wpb_widgetised_column .menu-item a:before{ color:'.$mc_alt_hl_color.';}';
	$output .= '#wp-calendar caption{background:'.$sb_heading.'; color:'.$sb_alt_bg.'}#wp-calendar{border:1px solid '.$sb_border.'}#wp-calendar th{color:'.$mc_alt_hl_color.';}#wp-calendar tbody td a{color:#fff; background:'.$mc_alt_hl_color.';}#wp-calendar tbody td a:hover{color:#fff; background:'.$sb_hover.';}#wp-calendar td#next a:hover:after,#wp-calendar td#prev a:hover:after{background:'.$sb_hover.';}';
	$output .= '.rd_widget_recent_entries .thumbnail a:before,.port_tn a:before,.rd_widget_recent_entries_f .thumbnail a:before{background:'.$mc_alt_hl_color.';}';
...
/*-----------------------------------------------------------------------------------*/
	...
	$output .= '#member_email a:hover, .sc-share-box #member_email a, .single_staff_social #member_email a,.share_icons_business .share-box #member_email a{background:'.$mc_hl_color.';}';
