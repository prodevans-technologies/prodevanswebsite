...
<div class="post_b_date"> <?php echo get_the_time('j F, Y'); ?> </div>
</div>
...
<?php 
            ...
            <?php if($now_open_works !== 0 && $last_month == '' && $current_month !== $current_post_month || $now_open_works !== 0  && $current_post_month !== $last_month && $last_month !== ''){ echo '<div class="ajax_post post_masonry new_month_post"></div>'; } ?>
...
if ( $post_format !== 'quote' ) { ?>
    ...
    <div class="post-info"><?php echo __('By', 'thefoxwp'); ?> <?php the_author_posts_link(); ?>    |    <?php the_category(',');  ?></div>
