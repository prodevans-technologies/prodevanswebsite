...
if ($pt_style == 'rd_pt_13'){
	$output .= '#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_0  .pricetable-button-container a{background-color:'.$color_1.';}#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_0  .pt_price{color:'.$color_1.'; }';
	$output .= '#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_1 .pricetable-button-container a{background-color:'.$color_2.';}#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_1 .pt_price{color:'.$color_2.'; }';
	$output .= '#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_2 .pricetable-button-container a{background-color:'.$color_3.';}#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_2  .pt_price{color:'.$color_3.'; }';
	$output .= '#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_3 .pricetable-button-container a{background-color:'.$color_4.';}#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_3  .pt_price{color:'.$color_4.'; }';
	$output .= '#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_4 .pricetable-button-container a{background-color:'.$color_5.';}#pt_'.$pt_id.'.rd_pt_13 .pt_col_nb_4 .pt_price{color:'.$color_5.'; }';
