...
elseif($style == 'rd_tm_21' ){

	$output.= '#tm_'.$id.'.rd_tm_21 .tm_author{ color:'.$h_color.';}#tm_'.$id.'.rd_tm_21 .tm_author:before{ border-color:'.$b_color.';}#tm_'.$id.'.rd_tm_21 .tm_text,#tm_'.$id.'.rd_tm_21 .tm_info{color:'.$t_color.'; }#tm_'.$id.'.rd_tm_21 .rd_tm_pager a{background:'.$t_color.';}#tm_'.$id.'.rd_tm_21 .rd_tm_pager a.selected{background:'.$hl_color.';}';	
