...
if( $alt_color == '' ){
$output .='#l_'.$id.'.sc_line ,#l_'.$id.' .sc_line { height:1px; background:'.$color.';}';
}else {

$output .='#l_'.$id.'.sc_line ,#l_'.$id.' .sc_line { height:1px; background: '.$color.'; background: -moz-linear-gradient(90deg, '.$color.' 0%, '.$alt_color.' 100%); background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,'.$color.'), color-stop(100%,'.$alt_color.')); background: -webkit-linear-gradient(90deg, '.$color.' 0%,'.$alt_color.' 100%); background: -o-linear-gradient(90deg, '.$color.' 0%,'.$alt_color.' 100%); background: -ms-linear-gradient(90deg, '.$color.' 0%,'.$alt_color.' 100%); background: linear-gradient(90deg, '.$color.' 0%,'.$alt_color.' 100%);}';	
}
