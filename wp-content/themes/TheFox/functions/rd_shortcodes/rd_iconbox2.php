...
if($change_hover !== ''){
	...
	$output .='<style>#rand_'.$box_id.':hover h3{color:'.$i_color.'!important;}#rand_'.$box_id.':hover {border-bottom:3px solid '.$hover_i_color.'!important; padding:43px 30px 18px 30px!important;}#rand_'.$box_id.':hover .simple_sub_circle{background:#2d3e50 !important;},#rand_'.$box_id.':hover {background:'.$hover_boxbg_color.' !important; border:1px solid '.$hover_boxb_color.' !important; color:'.$hover_text_color.'!important;}#rand_'.$box_id.':hover .icon_circle{background:'.$hover_i_color.' !important; border:1px solid '.$hover_boxb_color.'!important;}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if($i_alt_color !== '' ){ 
	$output .='<style>#rand_'.$box_id.' .icon_circle{ background: '.$i_color.'; background: -moz-linear-gradient(45deg, '.$i_color.' 0%, '.$i_alt_color.' 100%); background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,'.$i_color.'), color-stop(100%,'.$i_alt_color.')); background: -webkit-linear-gradient(45deg, '.$i_color.' 0%,'.$i_alt_color.' 100%); background: -o-linear-gradient(45deg, '.$i_color.' 0%,'.$i_alt_color.' 100%); background: -ms-linear-gradient(45deg, '.$i_color.' 0%,'.$i_alt_color.' 100%); background: linear-gradient(45deg, '.$i_color.' 0%,'.$i_alt_color.' 100%);}</style>';
		}
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_big_cg_business '.$animation.'"><div class="icon_circle"><div class="icon_sub_ctn"><i class="'.$icon.'" ></i></div></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
