...
$output_string .= '<div class="'.$style.' clearfix" id="b_'.$button_rand_class.'" ><a class="f_btn '.$f_animation.'" href="'.$f_url.'" target="'.$f_target.'" >'.$f_b_text.'</a><a class="s_btn '.$s_animation.'" href="'.$s_url.'" target="'.$s_target.'" >'.$s_b_text.'</a></div>';
