...
$output .='.rd_pb_3 #pb_'.$pbid.' .pb_percentage,.rd_pb_8 #pb_'.$pbid.' .pb_percentage,.rd_pb_9 #pb_'.$pbid.' .pb_percentage,.rd_pb_10 #pb_'.$pbid.' .pb_percentage{left:'.$percentage.'%; content:""!important; }.rd_pb_3 #pb_'.$pbid.' .pb_percentage:before,.rd_pb_8 #pb_'.$pbid.' .pb_percentage:before,.rd_pb_9 #pb_'.$pbid.' .pb_percentage:before,.rd_pb_10 #pb_'.$pbid.' .pb_percentage:before{content:"'.$percentage.'%";}';
