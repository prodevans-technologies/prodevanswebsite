...
if($type == '12'){
	...
	$output .='<div class="rd_count_to count_style_12  '.$animation.'"  id="rand_'.$c_id.'" ><div class="count_number" data-from="0" data-to="'.$number.'" data-speed="'.$speed.'" data-refresh-interval="25" data-decimals="'.$decimals.'" style="color:'.$number_color.'">0</div><span class="count_title" style="color:'.$heading_color.'">'.$content.'</span></div>';
