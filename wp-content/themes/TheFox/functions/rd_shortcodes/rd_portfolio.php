...
if ( $filter !== ''){
		if ($tags == "all" || $tags=="") {
			...
			if($filter_type == 'filter_type_3' ||$filter_type == 'filter_type_4' || $filter_type == 'filter_type_5' || $filter_type == 'filter_type_6'  || $filter_type == 'filter_type_7' ){?>
        		<li class="portfolio_sorts"><a><?php echo __('Sort by','thefoxwp'); ?></a><ul id="sorts"  class="button-group"><li data-sort-by=""><?php echo __('default','thefoxwp'); ?></li><li data-sort-by="date"><?php echo __('date','thefoxwp'); ?></li><li data-sort-by="name"><?php echo __('name','thefoxwp'); ?></li></ul></li>
			<?php }
